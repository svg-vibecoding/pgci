  ...
  return (
    <form onSubmit={handle} className="space-y-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            {v.scope === "unit" ? (
              ...
              <Input id="unit_name" value="Cobertura nacional" disabled readOnly />
            )}
          </div>
        </div>
      ...
      {!lockClient && (
        <AgreementGroupPicker
          value={{
            group_mode: v.group_mode,
            group_id: v.group_id,
            group_name: v.group_name,
            group_observations: v.group_observations,
          }}
          ...
          errors={{ group_id: errors.group_id, group_name: errors.group_name }}
        />
      )}
